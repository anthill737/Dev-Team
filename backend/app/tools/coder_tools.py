    ...
    return [
        ...
        ToolSpec(
            ...
            description=(
                ...
                "you're done.\n\n"
                "  status='approved' — DEFAULT. Use this when your tests pass and your "
                "reflective practice didn't surface real issues. After every task a "
                "skeptical Reviewer agent verifies your work against the acceptance "
                "criteria — they read files, run tests, exercise APIs, and judge "
                "independently. You don't need extra confidence to pick approved; the "
                "Reviewer is the safety net. Provide `summary`.\n\n"
                "  status='needs_user_review' — RARE. Reserved for the irreducible case "
                "where a HUMAN with eyes is the only viable verifier: visual aesthetics, "
                "'does this color scheme feel readable', 'is this game fun to play'. "
                "The Reviewer can run shell commands, exercise APIs, click through UI "
                "flows, and verify nearly any acceptance criterion that has a concrete "
                "outcome. If a criterion can be checked by running a command or "
                "inspecting output, that's Reviewer territory — pick approved. Pausing "
                "for the user is expensive; they may be away from the keyboard and the "
                "project blocks until they return. Use this status sparingly and only "
                "when literal human eyes are required. If you do pick this status, "
                "provide `summary`, `review_checklist` (specific steps), and "
                "`review_run_command` (exact copy-paste command).\n\n"
