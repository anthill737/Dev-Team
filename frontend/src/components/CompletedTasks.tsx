  ...
  return (
    <div className="h-full flex flex-col">
      <div className="px-4 py-3 border-b border-line">
        <h2 className="text-[17px] font-semibold">Completed tasks</h2>
      ...
      <div className="flex-1 overflow-y-auto">
        {phases.length === 0 && (
          <div className="p-4 text-[15px] text-gray-500 italic">
  ...
  return (
    <div className="px-4 py-2 border-b border-line/50 last:border-b-0">
      <div className="flex items-baseline gap-2">
        <span className="text-[15px] font-mono text-emerald-500">{task.id}</span>
        <span className="text-[15px] text-gray-200 truncate">{task.title}</span>
      </div>
      {summary && (
        <div className="mt-1 text-[15px] text-gray-400 break-words">{summary}</div>
      )}
      <div className="mt-1 text-[13px] text-gray-500 font-mono">
        {time}
        {iterationsLabel}
      </div>
    </div>
